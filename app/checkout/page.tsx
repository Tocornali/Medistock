            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                {items.map((item) => (
                  <div key={item.id} className="flex justify-between text-sm">
                    <span className="text-slate-600 truncate pr-4">{item.cantidad}x {item.nombre}</span>
                    <span className="font-medium text-slate-800">{formatCurrencyCLP(item.precio * item.cantidad)}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="border-t border-slate-200 pt-4 mt-4">
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-3xl font-black text-blue-600">{formatCurrencyCLP(total)}</span>
                </div>
              </div>
            </div>
          </div>
