        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <RutInput
              ...
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-brand-primary focus:ring-brand-primary/50 sm:text-sm"
              value={rut}
          ...
          <button
            type="submit"
            disabled={pending}
            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-primary hover:bg-[#1A9089] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary/50 disabled:opacity-50"
          >
