...
export default function CartIndicator() {
  ...
  return (
    <div className="fixed top-2 right-4 z-50">
      <Link href="/carrito" className={`relative bg-white p-3 rounded-full shadow-lg border border-slate-200 flex items-center justify-center cursor-pointer hover:shadow-xl transition-all duration-300 block ${isAnimating ? 'scale-125' : 'scale-100'}`}>
